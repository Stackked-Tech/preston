...
-- ============================================================
-- Template Documents & Fields (added for template builder)
-- ============================================================
...
-- Add fill_mode and label to sts_fields for envelopes created from templates
...
-- Indexes for template documents and fields
